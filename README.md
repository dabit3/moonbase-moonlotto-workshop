...
Now, in __src/mappings__ you will see code including imports for the types that were generated by the CLI:
...
It should look something like this: `username/subgraphname`:
